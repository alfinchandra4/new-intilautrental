...
<html lang="en">
  ...
  <body>
    ...
    <div class="container text-center mt-4 scaffolding-side">
      <span class="font-weight-bold h2 products text-uppercase">Scaffolding</span>
      <div class="mt-4">
      ...
      <div class="row">
        <div class="col-md-4 col-sm-12 mb-2 mt-2">
          <div class="card cardscaffolding border-0">
            <a class="example-image-link card-img-top" href="asset/image/scaffolding/mainframe.png" data-lightbox="scaffolding">
              <img src="asset/image/scaffolding/mainframe.png" class="card-img-top">
            </a>
            <div class="card-body">
